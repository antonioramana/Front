...
export default function FindCarsResult({allCar,erroMessage,successMessage,user, addToFavoris,handleDelete}) {
      ...
      <div className="container">
					...
					{!myFavorite.some((fav)=>fav.immatriculation===car.immatriculation) && <div className="card">
								...
								<div className="card-body">
									...
									{car.id_user !== user.id_user &&<button onClick={()=>{addToFavoris(car.immatriculation,car.id_user)}} className="mybtn btn text-end ms-2">Ajouter aux favoris</button>}
								</div>
							</div>}
					{myFavorite.some((fav)=>fav.immatriculation===car.immatriculation) && <div className="card">
								<img className="card-img-top" src={API_URL+"/images/"+car.image} />
